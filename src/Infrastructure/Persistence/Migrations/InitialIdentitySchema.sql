...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM auth."__EFMigrationsHistory" WHERE "MigrationId" = '20260521104703_InitialIdentitySchema') THEN
        IF NOT EXISTS(SELECT 1 FROM pg_namespace WHERE nspname = 'auth') THEN
            CREATE SCHEMA auth;
        END IF;
    END IF;
...
BEGIN
    ...
    VALUES ('20260521104703_InitialIdentitySchema', '10.0.8');
    END IF;
END $EF$;
COMMIT;
